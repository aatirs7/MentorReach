...
export const metadata = {
  title: 'Mentor with MentorReach',
  description:
    'Apply to mentor on MentorReach. Set your own rates and hours, get paid per session, and keep your day job. Applications take about 5 to 10 minutes.',
  alternates: { canonical: '/mentors/apply' },
  openGraph: {
    title: 'Mentor with MentorReach',
    description:
 ...
 *
 * This page targets real, low-competition intent ("how to become a career mentor"), which
 * is why it's the one marketing page carrying an FAQ graph.
 */
const FAQ: Array<{ q: string; a: string }> = [
  {
    q: 'Who can mentor on MentorReach?',
    a: 'People who currently hold the role others are trying to reach. We review every application personally, and we look for real, current experience in your field rather than a mentoring qualification.',
  },
  {
  ...
  },
  {
    ...
    a: 'You choose your own weekly hours and can block out dates. Most mentors offer a handful of sessions a month around a full-time job.',
  },
  {
...
/**
 * Public mentor application — the pre-vetting front door. No login; applicants create an
    ...
    <main className="flex-1">
      <JsonLd
        data={{
          ...
          '@type': 'FAQPage',
          '@id': `${absoluteUrl('/mentors/apply')}#faq`,
