...
export const metadata = {
  ...
  description:
    'How we expect mentors to operate on MentorReach. Completing onboarding means you agree to these standards.',
}

/**
 * Public, no login — an invited mentor reads this before signing up, and the onboarding
    ...
    <main className="flex-1">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <header className="rounded-2xl border border-line/20 bg-sand p-8 text-center sm:p-10">
          <p className="label-mono">For mentors</p>
          <h1 className="mt-3 text-4xl leading-tight sm:text-5xl">Mentor Handbook</h1>
          <p className="mx-auto mt-4 max-w-prose leading-relaxed text-slate">
            How we expect mentors to operate on MentorReach. Completing onboarding means you agree
        ...
        <section id="removal" className="mt-10 scroll-mt-6">
          <div className="rounded-2xl border border-destructive/30 bg-destructive/5 p-6 text-center sm:p-8">
            ...
            <p className="mx-auto mt-3 max-w-prose leading-relaxed text-ink/90">
              We personally selected every mentor here, and we will remove anyone who breaks that
        ...
        <Section id="the-bar" eyebrow="The point" title="The bar we hold">
          <P>
            ...
            thing they are trying to do, and that we personally review every mentor before they
        ...
        <div className="mt-12 rounded-2xl border border-line/20 bg-secondary p-8 text-center">
          ...
          <Button asChild size="lg" className="mt-5">
            <Link href="/mentor/setup">Continue setup</Link>
          </Button>
        </div>
      </div>
    </main>
