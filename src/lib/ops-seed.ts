...
export const OPS_SEED: Record<OpsCategory, OpsSeedTask[]> = {
  'Business & Legal': [
    ...
    { title: 'Confirm mentor tax handling', owner: 'Both', status: 'done', details: 'Resolved: mentors are independent contractors; Stripe issues their 1099-K through Connect. The LLC does not 1099 mentors and only reports the commission it keeps.' },
  ...
  'Website & Product': [
    ...
    { title: 'Self-serve mentor onboarding (auto-publish, drop approval gate)', owner: 'Aatir', status: 'in_progress', details: 'Building now.' },
    { title: 'Mentor handbook page + acknowledgment', owner: 'Aatir', status: 'in_progress', details: 'Content drafted; /mentor/handbook plus a required "read and agree" checkbox before publish.' },
    ...
    { title: 'Verify the is_seed photo guardrail', owner: 'Aatir', status: 'todo', details: 'Test a real mentor with no photo shows initials, never a placeholder face.' },
  ...
  'Founding Mentors': [
    { title: 'Send onboarding emails to all 9 mentors', owner: 'Both', status: 'todo', details: 'Blocked until the verification-copy removal, broad categories, and self-serve onboarding are live. Use the short nudge email.' },
