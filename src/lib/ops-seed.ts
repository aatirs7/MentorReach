...
export const OPS_SEED: Record<OpsCategory, OpsSeedTask[]> = {
  'Business & Legal': [
    ...
    { title: 'Open a business bank account', owner: 'Both', status: 'todo', details: 'In the LLC name; needs EIN + filed articles. All Trajectory money flows through it.' },
  ...
  'Website & Product': [
    ...
    { title: 'Domain trajectorycoaches.com on Vercel', owner: 'Aatir', status: 'done' },
