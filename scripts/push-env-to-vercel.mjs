...
const TARGETS = [
  ...
  { key: 'ZOOM_ACCOUNT_ID', envs: ['production', 'preview', 'development'] },
  { key: 'ZOOM_CLIENT_ID', envs: ['production', 'preview', 'development'] },
  { key: 'ZOOM_CLIENT_SECRET', envs: ['production', 'preview', 'development'] },
